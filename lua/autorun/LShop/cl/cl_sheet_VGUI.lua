...
surface.CreateFont("LShop_Sheet_Label", 
{
	font		= "Segoe UI Light",
	size		= 20,
	weight		= 1000
...
function PANEL:Init()
	...
	self:SetFont("LShop_Sheet_Label")
...
derma.DefineControl( "LShop_Tab", "", PANEL, "DButton" )
...
function PANEL:AddSheet( label, panel, material, NoStretchX, NoStretchY, Tooltip )
	...
	Sheet.Tab = vgui.Create( "LShop_Tab", self )
...
derma.DefineControl( "LShop_PropertySheet", "", PANEL, "Panel" )
