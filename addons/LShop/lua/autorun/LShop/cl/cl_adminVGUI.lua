...
function LShop.cl.Admin( parent, tab )
	...
	Menu2Panel.Paint = function( panel, w, h ) 
		...
		if ( LShop.Config.Version ) then
			draw.SimpleText( LShop.lang.GetValue_Replace( "LShop_AdminMenu_Menu02_CurVerStr", { LShop.Config.Version } ), "LShop_Category_Text", w * 0.5, h * 0.2, Color( 0, 0, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
		if ( new_version != "" ) then
			draw.SimpleText( LShop.lang.GetValue_Replace( "LShop_AdminMenu_Menu02_NewVerStr", { new_version } ), "LShop_Category_Text", w * 0.5, h * 0.2 + 30, Color( 0, 0, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		...
		draw.SimpleText( "Copyright (C) 2014 ~ 'Cyanide Team' - Team Leader : L7D.", "LShop_Intro_LoadText", w * 0.5, h - 60, Color( 0, 0, 0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	end
